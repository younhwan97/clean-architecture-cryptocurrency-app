...
import kr.co.younhwan.cleanarchitecturecryptocurrencyapp.domain.use_case.get_coins.GetCoinsUseCase
    ...
    private fun getCoins() {
        getCoinsUseCase().onEach { result ->
            when (result) {
                ...
                is Resource.Error -> {
                    _state.value = CoinListState(error = result.message ?: "An expected error")
                }
